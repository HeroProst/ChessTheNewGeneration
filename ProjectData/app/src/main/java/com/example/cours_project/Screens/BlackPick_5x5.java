...
public class BlackPick_5x5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_black_pick5x5);
        ...
        whiteField = DataGiver.WhiteField_5x5;
    ...
    public void setSelectedFigure(View view)
    {
        ...
        ImageButton clearButton = findViewById(R.id.C5_figure);
    ...
    {
        ImageButton newButton = findViewById(view.getId());
        ImageButton clearButton = findViewById(R.id.C5_figure); //cell with clear square
        Cell btnCell = new Cell();
        for(int i = 0; i < gameField.gameField.length;i++) {
            for (int j = 0; j < gameField.gameField[0].length; j++) {
                if(gameField.gameField[i][j].linketButton == newButton) {
    ...
    {
        Intent gameScreen = new Intent(this, GameScreen_5x5.class);
        for(int i = 0; i < gameField.gameField.length;i++) {
            for (int j = 0; j < gameField.gameField[0].length; j++) {
                if(gameField.gameField[i][j].linketButton == null)
        ...
        DataGiver.BlackAndWhiteField_5x5 = gameField;
