...
public class BlackPick_8x8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_black_pick);
        ...
        whiteField = DataGiver.WhiteField_8x8;
    ...
    {
        Intent gameScreen = new Intent(this, GameScreen_8x8.class);
        for(int i = 0; i < gameField.gameField.length;i++) {
            for (int j = 0; j < gameField.gameField[0].length; j++) {
            if(gameField.gameField[i][j].linketButton == null)
        ...
        DataGiver.BlackAndWhiteField_8x8 = gameField;
